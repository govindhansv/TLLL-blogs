...
const Footer = () => {
    return (
        ...
        <footer class="w-auto p-4 bottom-0 h-auto relative bg-black ">
            <div class="lg:flex  lg:mt-3 md:mx-12 lg:mx-28 lg:justify-between">
                <div class="mb-4 lg:columns-1 w-96">
                    ...
                    <div className="foot-main">
                        <div className="foot-logo">
                            ...
                            <h5 className="text-white font-bold mb-1 mt-3">Live and let Live </h5>
                        </div>
                    </div>
                    <p className="text-gray-200 text-sm">The only way to deal with an unfree world is to become so absolutely free that your very existence is an act of rebellion</p>
                </div>
                ...
                <div class="lg:mt-3 mb-4">
                    ...
                    <div class="columns-2 md:columns-3 lg:columns-2">
                        <a class="text-gray-200" href="">Navigate 0</a><br></br>
                        <a href="" class="text-gray-200">Navigate 1</a><br></br>
                        <a class="text-gray-200" href="">Navigate 2</a><br></br>
                        <a class="text-gray-200" href="">Navigate 3</a><br></br>
                        <a href="" class="text-gray-200">Navigate 4</a><br></br>
                        <a href="" class="text-gray-200">Navigate 5</a><br></br>
                    </div>
                </div>
            </div>
            <div>
